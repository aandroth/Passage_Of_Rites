...
public class Testing : MonoBehaviour
{
    ...
    public IEnumerator TestPlayerSupplyItemInteractingWithSupplyStation(float timeToWait)
    {
        ...
        Assert.AreEqual(SupplyItemName.NOTHING, m_playerSupplyItem.m_supplyStationResourceName);
        ...
        yield return new WaitForSeconds(0.1f);
        Assert.False(m_station.m_isUsable);
        Assert.AreEqual(SupplyItemName.ROPE, m_playerSupplyItem.m_supplyStationResourceName);
        Debug.Log("PlayerSupplyItem tests Passed");
    }
    ...
    //    yield return new WaitForSeconds(0.1f);
    //    Assert.False(m_station.m_isUsable);
    //    Assert.AreEqual(SupplyStationName.ROPE, m_playerSupplyItem.m_supplyName);
    //    Debug.Log("PlayerSupplyItem tests Passed");
    //}
#endif
}
